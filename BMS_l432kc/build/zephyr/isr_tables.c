...
struct _isr_table_entry __sw_isr_table _sw_isr_table[83] = {
	...
	{(const void *)0x8003bcb, (ISR)0x8000e09}, /* 6 */
	{(const void *)0x8003bc9, (ISR)0x8000e09}, /* 7 */
	{(const void *)0x8003bc7, (ISR)0x8000e09}, /* 8 */
	{(const void *)0x8003bc5, (ISR)0x8000e09}, /* 9 */
	{(const void *)0x8003bc3, (ISR)0x8000e09}, /* 10 */
	...
	{(const void *)0x8003bc1, (ISR)0x8000e09}, /* 23 */
	...
	{(const void *)0x8003bbf, (ISR)0x8000e09}, /* 40 */
